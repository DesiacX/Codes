########################################################################
SSS CSE Paths except in a different file that's loaded between the SSS and CSS [Desi]
########################################################################
    
string "/menu2/selmapMP+.pac" @ $806FF3F0   #String Legnth must remain the same
string "selmapMP+_en.pac" @ $817F637C      #Selmap
